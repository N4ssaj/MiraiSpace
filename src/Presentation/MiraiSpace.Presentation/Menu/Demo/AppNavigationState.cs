...
public sealed class AppNavigationState : ModelBase
{
    ...
    public string Eyebrow { get => _eyebrow; private set => this.RaiseAndSetIfChanged(ref _eyebrow, value); }
    ...
    public string Accent { get => _accent; private set => this.RaiseAndSetIfChanged(ref _accent, value); }
